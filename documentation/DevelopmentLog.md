...
Ну вот порисовал немного. Сделал привидения и червя чуть подрисовал. Вот что получилось:

[![video](http://img.youtube.com/vi/PLsmZ2Xiwc8/0.jpg)](https://www.youtube.com/watch?v=PLsmZ2Xiwc8&feature=youtu.be)

---

## 23 марта 2015

Почему-то в выходные никак не получается пополнить этот дневничок. Да и в пятницу. Но то можно свалить на затменее :)

![doodle](log/23032015-eclipse-doodle.png)

Небольшая печаль еще. Как-то с этим всем затмением прервалась самая длинная за год полоска на гитхабе...

![github](log/23032015-github.png)

Даже не понимаю как такое могло произойти. Много всего было сделано в пятницу, но не сделано ни одного коммита.

Впрочем в этом вообще нет ничего страшного :)

Половину воскресения провел валяясь на диване и ковыряясь в ***SunVox***. Неожиданно получил массу удовольствия от процесса! То, что получилось в первые пару часов выкинул в помойку (на самом деле сохранил на всякий случай, даже здесь, на гитхабе [файл](../source/main-theme-v1.sunvox) есть)

Получился эдакий убогенький драм-н-бейс. Я люблю драм-н-бейс. Мне понравилось что получилось, но для темы игры подходит не очень. Впрочем уже нет времени делать новую тему.

![SunVox](log/23032015-sunvox.png)

На список дел я уже явно плюнул :)

Но сегодня нужно собрать все воедино и сдаться. Формально условия уже почти соблюдены, просто надо привести все в порядок.

---

Ах да! Чуть не забыл. На днях вышел [PIXI](https://github.com/GoodBoyDigital/pixi.js) v3.0.0-rc3 в который вошло [несколько моих строк](https://github.com/GoodBoyDigital/pixi.js/blame/v3.0.0-rc3/src/core/math/Point.js) :) Мелочь, а приятно. Теперь можно переписать некоторые места в коде, в которых очень нехватало этих двух методов.

![contribution](log/23032015-pixi-contribution.png)
